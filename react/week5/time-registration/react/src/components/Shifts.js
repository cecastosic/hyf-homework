...
export default function Shifts() {
  ...
  if (searchName) {
    filteredShiftsList = shiftsList.filter(shift => shift.employeeName.toLowerCase().includes(searchName));
  }
  ...
  return (
    ...
    <div>
      ...
      {userUid && userType === "employer" && <SearchEmployee shifts={{setSearchName}}/>}
      {userUid && filteredShiftsList && filteredShiftsList.length > 0 && (
      
        <EmployeeSearchTable shifts={{shiftsList: filteredShiftsList, price, userUid}}/>
